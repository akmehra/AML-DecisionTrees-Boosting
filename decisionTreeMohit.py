...
def calculate(data,userdepth,depth):
    ...
    if checkSame(data,label_index) == True:
        return DNode(result=results(data,traindata_label_index))
...
def calculate_bootstrap_accu(b,testdata):
    ...
    print "solution 1 len",len(solution1)
...
if __name__ == "__main__":
    ...
    # traindatapath = datapath + '/agaricuslepiotatrain1.csv'
    # testdatapath = datapath + '/agaricuslepiotatest1.csv'
    # with open(traindatapath, 'r') as f:
    #     reader = csv.reader(f)
    #     temptrain = list(reader)
    # traindata = temptrain[1:]

    # f.close()
    # with open(testdatapath, 'r') as g:
    #     reader = csv.reader(g)
    #     temptest = list(reader)
    # testdata = temptest[1:]

    temptraindata = np.genfromtxt("agaricuslepiotatrain1.csv", delimiter=",", skip_header=1)
    ...
    temptestdata = np.genfromtxt("agaricuslepiotatest1.csv", delimiter=",", skip_header=1)
    ...
    for numbag in range(0,nummbags):
        ...
        tree = calculate(bootstrapdata,6,0)
        # printtree(tree)
